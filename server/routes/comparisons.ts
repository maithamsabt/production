      ...
      if (validRows.length > 0) {
        await db.insert(comparisonRows).values(
          validRows.map((row: any, index: number) => ({
            ...
            prices: row.prices || [],
            vendor1UnitPrice: row.vendor1UnitPrice || row.prices?.[0] || 0,
            vendor1Vat: row.vendor1Vat || 0,
            vendor1Total: row.vendor1Total || 0,
            vendor2UnitPrice: row.vendor2UnitPrice || row.prices?.[1] || 0,
            vendor2Vat: row.vendor2Vat || 0,
            vendor2Total: row.vendor2Total || 0,
            vendor3UnitPrice: row.vendor3UnitPrice || row.prices?.[2] || 0,
            vendor3Vat: row.vendor3Vat || 0,
            vendor3Total: row.vendor3Total || 0,
